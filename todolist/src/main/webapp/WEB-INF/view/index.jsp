...
<body>  
    <div class=wrapper>
        ...
        <div class="main_content" ng-controller="taskManagerCtrl">
            <aside>       
                <div class="filtr_block_title">Filter</div>
            
                <div class="filtr_control_block">
                    <p><a class="a_switcher" href ng-click="taskStatus=undefined;currentPage=0;">Everything</a></p>
                    <p><a class="a_switcher" href ng-click="taskStatus=true;currentPage=0;">Performed</a></p>
                    <p><a class="a_switcher" href ng-click="taskStatus=false;currentPage=0;">Not done</a></p>
                </div>
            </aside>    
            ...
            <article>                
                ...
                <div class="pagination_area">
                    ...
                    <div class="pagination_text">{{currentPage+1}} of {{numberOfPages()}}</div>
                    <div class="pagination_to_right_button" ng-click="pageForward()"></div>
                </div>              

                <div class=add_task_area>
                    <div class=add_task_title>Add a new task</div>
